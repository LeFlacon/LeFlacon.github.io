...
if(!norunFlag){
	...
	function initLive2d (){
		...
		if(musicList.length == 0){
			...
			if(live2dBGM_Num){
				if(live2dBGM_Num<=musicList.length-1){
	...
	$(document).ready(function() {
		var AIimgSrc = [
			home_Path + message_Path + "model/gf/moc/koharu.2048/texture_00.png"
		]
		var images = [];
		...
		for(var i=0;i<imgLength;i++){
			...
			images[i].onload = function(){
				...
				if(loadingNum===imgLength){
					...
					setTimeout(function(){
						loadlive2d("live2d", message_Path+"model/gf/koharu.model.json");
					},1000);
					initLive2d ();
					images = null;
				}
